...
mixin _$LoginScreenState {
 ...
 Map<String, String>? get formErrors; bool get isLoading; bool get isSuccess; String? get phone; String? get password; String? get messageKey;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginScreenState&&const DeepCollectionEquality().equals(other.formErrors, formErrors)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isSuccess, isSuccess) || other.isSuccess == isSuccess)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.password, password) || other.password == password)&&(identical(other.messageKey, messageKey) || other.messageKey == messageKey));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(formErrors),isLoading,isSuccess,phone,password,messageKey);
...
@useResult
$Res call({
 Map<String, String>? formErrors, bool isLoading, bool isSuccess, String? phone, String? password, String? messageKey
});
...
/// Create a copy of LoginScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? formErrors = freezed,Object? isLoading = null,Object? isSuccess = null,Object? phone = freezed,Object? password = freezed,Object? messageKey = freezed,}) {
  return _then(_self.copyWith(
formErrors: freezed == formErrors ? _self.formErrors : formErrors // ignore: cast_nullable_to_non_nullable
...
class _LoginScreenState implements LoginScreenState {
  const _LoginScreenState({required final  Map<String, String>? formErrors, required this.isLoading, required this.isSuccess, required this.phone, required this.password, required this.messageKey}): _formErrors = formErrors;
  

 final  Map<String, String>? _formErrors;
@override Map<String, String>? get formErrors {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginScreenState&&const DeepCollectionEquality().equals(other._formErrors, _formErrors)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isSuccess, isSuccess) || other.isSuccess == isSuccess)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.password, password) || other.password == password)&&(identical(other.messageKey, messageKey) || other.messageKey == messageKey));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_formErrors),isLoading,isSuccess,phone,password,messageKey);
...
/// Create a copy of LoginScreenState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? formErrors = freezed,Object? isLoading = null,Object? isSuccess = null,Object? phone = freezed,Object? password = freezed,Object? messageKey = freezed,}) {
  return _then(_LoginScreenState(
formErrors: freezed == formErrors ? _self._formErrors : formErrors // ignore: cast_nullable_to_non_nullable
as Map<String, String>?,isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,isSuccess: null == isSuccess ? _self.isSuccess : isSuccess // ignore: cast_nullable_to_non_nullable
as bool,phone: freezed == phone ? _self.phone : phone // ignore: cast_nullable_to_non_nullable
as String?,password: freezed == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
